...
{
  this.c.customer_name=this.app.applicant_name;
  this.c.customer_email=this.app.applicant_email;
...
alert(prof.annual_salary)
  ...
  sendEmail(s:string){
  alert(s)
  return this.http.post(this.sendEmailurl+"/"+s)
  }
